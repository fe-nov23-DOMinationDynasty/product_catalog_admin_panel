...
import { DataTable, User } from 'src/views/tables/TableUsers';
...
const MUITable = () => {
  ...
  const handleRowSelectionChange = (selected: User[]) => {
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        ...
        <Typography variant="body2">
          Use the table below to view users
        </Typography>
      </Grid>
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            ...
            <TextField label={selectedRow?.role} fullWidth margin="normal" />
